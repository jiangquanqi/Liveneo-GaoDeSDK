...
Pod::Spec.new do |s|
  ...
  s.author             = { "jiangquanqi" => "jiangquanqi0524@163.com" }
  # Or just: s.author    = "jiangquanqi"
  # s.authors            = { "jiangquanqi" => "jiangquanqi0524@163.com" }
  ...
  s.source       = { :git => "https://github.com/jiangquanqi/LiveneoGaoDeSDK.git", :tag => "#{s.version}" }
